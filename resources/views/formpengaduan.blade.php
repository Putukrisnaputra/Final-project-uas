          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Formulir <small>Pengaduan</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
        ...
        <div class="shadow sm:rounded-md sm:overflow-hidden">
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            <div class="grid grid-cols-3 gap-15">
              ...
              <label for="last_name" class="block text-sm font-medium text-gray-700">Nama pengaduan</label>
                <input type="text" name="nama" id="nama" autocomplete="family-name" value="{{(isset($pengaduan))?$pengaduan->nama:old('nama') }}" class="mt-1  @error('nama') border-red-500 @enderror  focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Ketik nama pengaduan">
             ...
             <div class="grid grid-cols-3 gap-15">
              ...
              <label for="last_name" class="block text-sm font-medium text-gray-700">Alamat</label>
                <input type="text" name="alamat" id="alamat" autocomplete="family-name" value="{{(isset($pengaduan))?$pengaduan->alamat:old('alamat') }}" class="mt-1  @error('alamat') border-red-500 @enderror  focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Ketik alamat pengaduan">
            ...
            <div class="grid grid-cols-3 gap-15">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="date" name="waktu" id="waktu" value="{{(isset($pengaduan))?$pengaduan->waktu:old('waktu') }}" class="@error('waktu') border-red-600 @enderror focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300  text-black">
                            </div>
              ...
              <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                <input type="text" name="email" id="email" autocomplete="family-name" value="{{(isset($pengaduan))?$pengaduan->email:old('email') }}" class="mt-1  @error('email') border-red-500 @enderror  focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Ketik email pengaduan">
             ...
             <div class="grid grid-cols-3 gap-15">
              ...
              <label for="namaperusahaan" class="block text-sm font-medium text-gray-700">Nama Perusahaan</label>
                <input type="text" name="namaperusahaan" id="namaperusahaan" autocomplete="family-name" value="{{(isset($pengaduan))?$pengaduan->namaperusahaan:old('namaperusahaan') }}" class="mt-1  @error('namaperusahaan') border-red-500 @enderror  focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Ketik namaperusahaan pengaduan">
              ...
              <label for="alamatperusahaan" class="block text-sm font-medium text-gray-700">Alamat Perusahaan</label>
                <input type="text" name="alamatperusahaan" id="alamatperusahaan" autocomplete="family-name" value="{{(isset($pengaduan))?$pengaduan->alamatperusahaan:old('alamatperusahaan') }}" class="mt-1  @error('alamatperusahaan') border-red-500 @enderror  focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Ketik alamatperusahaan pengaduan">
              ...
              <label for="jenisperusahaan" class="block text-sm font-medium text-gray-700">jenis Perusahaan</label>
                <input type="text" name="jenisperusahaan" id="jenisperusahaan" autocomplete="family-name" value="{{(isset($pengaduan))?$pengaduan->jenisperusahaan:old('jenisperusahaan') }}" class="mt-1  @error('jenisperusahaan') border-red-500 @enderror  focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Ketik jenisperusahaan pengaduan">
            ...
            <div class="grid grid-cols-3 gap-15">
              ...
              <label for="no_telp" class="block text-sm font-medium text-gray-700">No Telepon</label>
                <input type="text" name="no_telp" id="no_telp" autocomplete="family-name" value="{{(isset($pengaduan))?$pengaduan->no_telp:old('no_telp') }}" class="mt-1  @error('no_telp') border-red-500 @enderror  focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Ketik no_telp pengaduan">
              ...
              <div class="mt-1">
                <textarea name="pengaduan" rows="8" class="@error('pengaduan') shadow-sm focus:ring-indigo-500 @enderror focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Ketik Deskripsi pengaduan">
                {{(isset($pengaduan))?$pengaduan->pengaduan:old('pengaduan') }}
                </textarea>
              </div>
               <div class="text-xs text-red-500"> @error('pengaduan') {{$message}} @enderror</div>
            </div> <br>
              ...
              <div class="mt-1 flex justify-center px-6 pt-8 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div class="space-y-1 text-center">
                  @if(isset($pengaduan) && $pengaduan->gambar!='')
                      <img src="{{asset('storage/' .$pengaduan->gambar)}}" class="mx-auto h-12 w-12 text-gray-400 rounded" alt="">
